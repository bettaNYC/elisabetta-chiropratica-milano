const translations = {
    it: {
        ...
        nav_reviews: 'Testimonianze',
        nav_contact: 'Contatti',
        nav_cta: 'Prenota',
        hero_eyebrow: 'Chiropratica a Milano',
        hero_credentials: 'DR., DACNB',
        hero_tagline: 'La salute della tua colonna vertebrale è il punto di partenza per il tuo benessere.',
        hero_cta: 'Prenota una visita',
        ...
        r1_text: 'La Dott.ssa Alfonsi è semplicemente la MIGLIORE! Il suo approccio olistico e la combinazione di tanti trattamenti diversi — lavoro corporeo, energy work e aggiustamenti — ha fatto una differenza enorme per entrambi noi. Non vedo l\'ora di ogni seduta. Me ne vado sempre piena di speranza e rinnovata. La Dott.ssa Alfonsi si prende cura davvero dei suoi pazienti.',
        r2_text: 'Dopo la mia terza seduta, eseguita nell\'arco di 2 settimane, ho avuto il primo giorno senza dolore. E continuo ad averne! Cammino normalmente, riesco persino a fare esercizio di nuovo. Gli aggiustamenti erano delicatissimi — nessun crac brusco né torsioni. La consiglio assolutamente.',
        r3_text: 'È il 2023 e da quando seguo la Dott.ssa Alfonsi non ho più avuto un\'emicrania. Mi ha aiutata con problemi digestivi, forte mal di schiena, dolori all\'anca e alla gamba. Mi fido di lei più del mio medico di base per trattare i miei disturbi.',
        contact_label: 'Contatti',
        contact_heading: 'Prenota una visita',
        contact_sub: 'Chiamami per fissare un appuntamento o per qualsiasi domanda.',
        contact_location_label: 'Studio',
        contact_phone_label: 'Telefono',
        form_name: 'Nome e cognome',
        form_email: 'Email',
        form_message: 'Messaggio',
        form_submit: 'Invia',
        form_success: 'Messaggio inviato. Ti risponderò presto.',
        footer_sub: 'Chiropratica a Milano',
        footer_copy: '© 2026 Elisabetta Alfonsi. Tutti i diritti riservati.',
    },
    en: {
        nav_prefix: 'DC',
        nav_about: 'About',
        ...
        nav_contact: 'Contact',
        nav_cta: 'Book',
        hero_eyebrow: 'Chiropractor in Milan',
        hero_credentials: 'DC, DACNB',
        hero_tagline: 'The health of your spine is the starting point for your overall wellbeing.',
        ...
        r1_text: 'Dr. Alfonsi is simply the BEST! Her holistic approach & combination of many different treatments — body work, energy work and adjustments — has made such a difference in both of us. I always look forward to our sessions. I feel hopeful & renewed after each one. Dr. Alfonsi truly cares about her patients.',
        r2_text: 'After my third session, all done within 2 weeks, I had my first pain-free day. And I continue to have pain-free days! I\'m walking normally, even exercising again. All the adjustments were so gentle — no hard cracking or twisting of any sort. I would absolutely recommend her.',
        r3_text: 'It\'s 2023 and I haven\'t had a migraine since I started seeing Dr. Alfonsi. She has helped me with digestion problems, major back pain, as well as hip and leg pain. I trust her more than my general doctor to help treat me.',
        contact_label: 'Contact',
        contact_heading: 'Book a consultation',
        contact_sub: 'Call me to schedule an appointment or for any questions.',
        contact_location_label: 'Studio',
        ...
        footer_sub: 'Chiropractor in Milan',
        footer_copy: '© 2026 Elisabetta Alfonsi. All rights reserved.',
    }
};
...
function applyLanguage(lang) {
    ...
    document.title = lang === 'it'
        ? 'DR. Elisabetta Alfonsi, DACNB — Chiropratica a Milano'
        : 'Elisabetta Alfonsi DC, DACNB — Chiropractor in Milan';
